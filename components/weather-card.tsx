...
interface WeatherCardProps {
  ...
  weatherAlert?: string
  onClick: () => void
  cardStyle: "default" | "compact" | "detailed" | "minimal"
  removeCard: () => void
}
      ...
      <Card className="h-full">
        ...
        <CardContent>
          <div className="flex flex-col items-center justify-center h-[200px]">
            <p className="text-muted-foreground text-center mb-2">Data unavailable for {location}</p>
      ...
      <CardContent>
        ...
        <div className="grid grid-cols-2 gap-4 text-sm">
          ...
          {/* <div className="col-span-2">
            <p className="font-semibold mb-1">UV Index</p>
            <Badge className={uvRisk.color}>
              {weatherData.uvi || "N/A"} ({uvRisk.level})
            </Badge>
          </div>
          ...
          <div className="col-span-2">
            <p className="font-semibold mb-1">Precipitation (1h)</p>
            <span>{getPrecipitation()}</span>
          </div> */}

          {weatherData.air_quality_index && (
            <div className="col-span-2">
              <p className="font-semibold mb-1">Air Quality Index</p>
              <span>{weatherData.air_quality_index}</span>
            </div>
          )}
        </div>
